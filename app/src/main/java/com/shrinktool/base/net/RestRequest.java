        ...
        if (entry != null) {
            try {
                String json = new String(
                        entry.data, HttpHeaderParser.parseCharset(entry.responseHeaders));
