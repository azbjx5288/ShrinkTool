...
public class CycleViewPager extends Fragment implements OnPageChangeListener, View.OnTouchListener {
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            v.setOnClickListener(v1 -> {
                if (mImageCycleViewListener != null) {
                    if (isCycle) {
                        mImageCycleViewListener.onImageClick(currentPosition - 1, v1);
                    } else {
                        mImageCycleViewListener.onImageClick(currentPosition, v1);
                    }
                }
            });
            container.addView(v);
    ...
    private void setIndicator(int selectedPosition) {
        for (TextView indicator : indicators) {
            indicator.setBackgroundResource(R.drawable.cycleviewpager_indicator_circle_gray);
        }
