...
public class FragmentLauncher extends AppCompatActivity {
    ...
    public static final String KEY_ACTIONBAR = "fragment-actionBar";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean supportActionBar = getIntent().getBooleanExtra(KEY_ACTIONBAR, false);
        if (supportActionBar) {
            setContentView(R.layout.fragment_launcher_activity);
        ...
        ft.replace(supportActionBar? R.id.fragment_sub : android.R.id.content, fragment);
